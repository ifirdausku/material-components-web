...
# [14.1.0](https://github.com/ifirdausku/material-components-web/compare/v14.0.0...v14.1.0) (2023-11-01)


### Bug Fixes

* **button:** fix theme elevation resolver ([2528c1c](https://github.com/ifirdausku/material-components-web/commit/2528c1c3b6b2a9870807df8c03c49ea45db811b7))
* **textfield:** styles that override floating-label font-size take into account that clients can change this font-size. ([ebb636f](https://github.com/ifirdausku/material-components-web/commit/ebb636f3d44e1a194f822d7dfcb5d70feb817520))
* The focus ring shouldn't ignore the container-shape value ([7a3942e](https://github.com/ifirdausku/material-components-web/commit/7a3942e7ad206c3754dd34e2da62b88e4a9dc311))
* Use state-layer-size to correctly position the icon inside of an icon button ([0270229](https://github.com/ifirdausku/material-components-web/commit/02702296e31ef8f9e3068017c73b4740eb56b9cf))
* **card:** Fix card ripple issue - the ripple is a child of the primary action element. ([f43e0ce](https://github.com/ifirdausku/material-components-web/commit/f43e0ceb536056569898c0ffbe084acc2af54a81))
* **chip:** Propagate unhandled keyboard events ([6081d82](https://github.com/ifirdausku/material-components-web/commit/6081d829b081384ff8433a92bf91db364c588e16))
* **dialog:** Add tabindex=-1 to dialog surface and set its outline to 0 ([4e840d6](https://github.com/ifirdausku/material-components-web/commit/4e840d68533ef04e438c0b10f1047627a1d01e0c))
* **dialog:** fix dialog close button z-index in dark mode ([26bacc3](https://github.com/ifirdausku/material-components-web/commit/26bacc3feee6ea39c95b35b73c99040399b0f530))
* **floating-label:** Generate valid CSS calc ([304a94e](https://github.com/ifirdausku/material-components-web/commit/304a94e8bde786452d9d8c6b80e8e9e0d84bfcc2))
* **floating-label:** replaced incompatible value types in calc statement by compatible ones ([23073a3](https://github.com/ifirdausku/material-components-web/commit/23073a303310f5aad6a0fef0c2e96fd8dd7ab360))
* **focus:** Add z-index to focus ring. ([b0103d1](https://github.com/ifirdausku/material-components-web/commit/b0103d10aca7e6e8272cde283d9d36272702bf87))
* **focus:** Use validate.theme-styles in focus-ring.theme-styles. ([1f99f3c](https://github.com/ifirdausku/material-components-web/commit/1f99f3c5033b1712a737d04e7b7b40229bcb4134))
* **focus ring:** Using box-shadow instead of border for focus ring as animating on box-shadow is more performant. ([3a705fa](https://github.com/ifirdausku/material-components-web/commit/3a705fa1d18089ae89c481b5bdfdfed2d378742e))
* **focusring:** add real color to focus ring ([15b2215](https://github.com/ifirdausku/material-components-web/commit/15b22154036ffb0fcadc7b404125a016e28e2b23))
* **linearprogress:** Fix `track-color` in Theming API ([79b1b61](https://github.com/ifirdausku/material-components-web/commit/79b1b612b9ec10a42caf5946efdead14e44e7f7a))
* **linearprogress:** Fix buffer dots animation when track height is increased ([0c53abc](https://github.com/ifirdausku/material-components-web/commit/0c53abc81c05b9afecc127380c700c99fac5d2f8))
* **linearprogress:** Fix missing buffering keyframes ([ea21914](https://github.com/ifirdausku/material-components-web/commit/ea219142617255a2b365823701b6ea43ff9a9611))
* **list:** Allow alt + enter to select index for lists. ([113b1a3](https://github.com/ifirdausku/material-components-web/commit/113b1a38e87337fdd00c7495fda3299df2dbc317))
* **list:** Fix list leading/trailing icon theming ([36a4cba](https://github.com/ifirdausku/material-components-web/commit/36a4cba9944392b391b86d41405ee21fb97f4c22))
* **list:** Initialize selectedIndex as an array for checkbox list ([0347671](https://github.com/ifirdausku/material-components-web/commit/034767110778aab3e5f0a3240937d8a07c21197e))
* **list:** only set overflow hidden on mdc-list-item--with-leading-image ([033ae08](https://github.com/ifirdausku/material-components-web/commit/033ae083aad9ad4376e64aa328df936c7adb5a32))
* **list:** Remove ripple styles for disabled items in deprecated list. ([f52358d](https://github.com/ifirdausku/material-components-web/commit/f52358dd0796308919bb78deffc573d0d933c7de))
* **menu:** Account for empty map being passed to theme mixin ([0c52ade](https://github.com/ifirdausku/material-components-web/commit/0c52adeab4a46fb942e7ac64a950d094b54716f8))
* **menu:** do not require all for theme-styles ([1fb4b1a](https://github.com/ifirdausku/material-components-web/commit/1fb4b1a063ecaec1ad0d508b3f5ae5aca3e96652))
* **menu:** make require-all a theme-styles param. ([c64a277](https://github.com/ifirdausku/material-components-web/commit/c64a2776efe4f0aaaee5c32f5fb9ef3570483213))
* **menusurface:** Make "private" `base_` mixin truly private ([da22ca9](https://github.com/ifirdausku/material-components-web/commit/da22ca960bdac2e0a0fc9e67f6dc1e1164fbe73b))
* **menusurface:** reposition menu surface on window resize events ([6023b1c](https://github.com/ifirdausku/material-components-web/commit/6023b1cd3d2c1213d47ac68e053293270e3e371f))
* **select:** update text field in select to accept dynamic shape and height ([aa5ac7f](https://github.com/ifirdausku/material-components-web/commit/aa5ac7fe52b870752cd578715ad1760731c63aa5))
* **select:** use `text-field-disabled-trailing-icon-color` token ([adcdb7d](https://github.com/ifirdausku/material-components-web/commit/adcdb7db997f3d471346b05f7b8aefec522a96c2))
* **slider:** Move comment to correct location ([d7a2277](https://github.com/ifirdausku/material-components-web/commit/d7a2277dee780757318ff962277c109a7c615e12))
* **slider:** Remove support for deprecated `label-label-text-font-size` token ([8a74f7c](https://github.com/ifirdausku/material-components-web/commit/8a74f7c6d4dffc9e066d548e74ebd7ab1c58ac65))
* **slider:** Replace `label-label-text-font-size` token with `label-label-text-size` ([73537ab](https://github.com/ifirdausku/material-components-web/commit/73537ab0fe98dbf2dc4b824c128c4c05da6ff986))
* **slider:** Use CSS Variables instead of hardcoded values for track height ([067af7e](https://github.com/ifirdausku/material-components-web/commit/067af7eff1cc5f3de077068184dfbd31c76f5a41))
* **tabs:** Add validation to tab bar theme ([49041a6](https://github.com/ifirdausku/material-components-web/commit/49041a6c3c713973d289f7a7f3ffa4a991304620))
* **tabs:** adjust rippple area according to container shape ([8c0786d](https://github.com/ifirdausku/material-components-web/commit/8c0786d6f0dca33f9666912598386a04ca153d97))
* **textfield:** Add coverage for suffix and prefix text within the font size mixin. ([19bb36a](https://github.com/ifirdausku/material-components-web/commit/19bb36a46b51e79d8bf08948ab5b7d8e9358c2d8))
* **textfield:** add support for placeholder color in theme api ([b994146](https://github.com/ifirdausku/material-components-web/commit/b994146f6d849bd80f280c147d64adae5b930a3c))
* **theme:** account for null being passed into .theme-styles ([2a9697d](https://github.com/ifirdausku/material-components-web/commit/2a9697dc53e9c7b5b89cc479df9f97a46c095a43))
* correct behavior of checkboxes/radios in a list. ([f771b09](https://github.com/ifirdausku/material-components-web/commit/f771b091ce1e5b1b97b3a508f1459e4665008a80))
* **base:** Fix compiler errors for TS 4.8 upgrade ([c8bdf61](https://github.com/ifirdausku/material-components-web/commit/c8bdf6144912e20bc616a268404e4f6bc9c45ae3))
* **button:** add `pressed-outline-color` key ([ab55c07](https://github.com/ifirdausku/material-components-web/commit/ab55c07d28e2a10b30260021e97f8c337208e937))
* **button:** Add line-height: initial to button progress indicator class ([602fe8e](https://github.com/ifirdausku/material-components-web/commit/602fe8efa3f3c9a41c7f74a7c5717a0abdec0c60))
* **chips:** Add missing tokens for leading icon for validation ([4356e05](https://github.com/ifirdausku/material-components-web/commit/4356e05c5e17a58d0a714e9f087db4b5060085bd))
* **chips:** Update elevation resolver function and mixins that apply elevation ([96f4726](https://github.com/ifirdausku/material-components-web/commit/96f472604cd098572f50987262bcab933574f7b2))
* **chips:** Update elevation resolver function and mixins that apply elevation ([a0ae73b](https://github.com/ifirdausku/material-components-web/commit/a0ae73b0e05a584715b2ec2841c033267f914c34))
* **chips:** Update elevation resolver logic and update suggestion chip accordingly ([7c35e50](https://github.com/ifirdausku/material-components-web/commit/7c35e503698c72d1d848d1429cbb3106d555930d))
* **chips:** Update theme mixins to use the new resolver function ([05fb07f](https://github.com/ifirdausku/material-components-web/commit/05fb07f9fd11ebf692b74591bc944360f613108f))
* **datatable:** Add extra class to pagination Select to fix GM3 styles ([ce8b532](https://github.com/ifirdausku/material-components-web/commit/ce8b5326fa2f15bd4e4d0a653a37d0d1a4bbf315))
* **datatable:** Don't use top-level `.mdc-data-table` selector in `theme-styles` ([2c1a8f8](https://github.com/ifirdausku/material-components-web/commit/2c1a8f8fdd53fd509bec519c1d92c1171c75b177))
* **datatable:** Remove unsupported token ([a5fe069](https://github.com/ifirdausku/material-components-web/commit/a5fe069d51e80ab17ab26c902401e75fd8968509))
* **datatable:** Update `static-styles` mixin with remaining styles ([bacda48](https://github.com/ifirdausku/material-components-web/commit/bacda4885c1f9e15eb4eba15bef2f56b329ef085))
* **dom:** transparent-border mixin RTL bugfix ([395f1ce](https://github.com/ifirdausku/material-components-web/commit/395f1ce61c0056590edd1f7b629f17c4d8599115))
* **dom:** transparent-border mixin RTL bugfix ([07acdde](https://github.com/ifirdausku/material-components-web/commit/07acddef343184362c317a57957a483b4c62cac4))
* **focus:** focus-ring.theme-styles now ingests custom properties emitted by focus-ring.theme. focus-ring.theme now accepts only one target-shape theme property, and the focus ring will mold around it. ([a69c14e](https://github.com/ifirdausku/material-components-web/commit/a69c14e10f605e54404d8ceac402c4e5d55d818f))
* **iconbutton:** support custom properties as values for an icon button ([68aaed9](https://github.com/ifirdausku/material-components-web/commit/68aaed940081f45cc1730e684c70e132793b6633))
* **list:** Fixes how list handles `CTRL-A` keyboard interactions for multi-selection lists when there are disabled list items. ([a911b38](https://github.com/ifirdausku/material-components-web/commit/a911b386b2fded69e3468ef42e7ef25eb33fcd70))
* **list:** Fixing css for calculating `$mdc-list-subheader-margin` param. ([357f2e5](https://github.com/ifirdausku/material-components-web/commit/357f2e5f15f6374c9d93da135a8b070239ba7464))
* **list:** rolling back update of list styles since this is causing failures. ([eb103d4](https://github.com/ifirdausku/material-components-web/commit/eb103d4b5d33e0d1535ea28ca0089d2c7002fab6))
* **menusurface:** Allow for having (non hoisted) menu inside an overflow hiding parent. ([03618ab](https://github.com/ifirdausku/material-components-web/commit/03618ab70c69118c7dda1c301a30aff4e5318458))
* **menusurface:** Calculate available space on left using `anchorMargin.left` when positioning menu. ([13eea1b](https://github.com/ifirdausku/material-components-web/commit/13eea1b2d64cdc79f86cf065afb32e461c3d7b2b))
* **slider:** Move opacity target declaration ([e741b5c](https://github.com/ifirdausku/material-components-web/commit/e741b5c82c7752c36745616d9bc407af590be7d4))
* **slider:** resolve a couple of errors with new theming API ([8d7ae91](https://github.com/ifirdausku/material-components-web/commit/8d7ae912ab32815d2f01e8540bc49751b8fad38d))
* **slider:** resolve more compilation errors ([db414b8](https://github.com/ifirdausku/material-components-web/commit/db414b864f4c248439d916d4ee36cd43316927ea))
* **tabs:** Add already supported tokens to the theme list ([3a1f46c](https://github.com/ifirdausku/material-components-web/commit/3a1f46c6692c2ee2130de7712722c548928624eb))
* rollback of cl/491630368 ([168a629](https://github.com/ifirdausku/material-components-web/commit/168a629a45d885cb6d8778c2d3a75ddf1cd2992a))
* **select:** apply `text-field-error-label-text-color` tokens. ([01da0ca](https://github.com/ifirdausku/material-components-web/commit/01da0cabb367ea0a250885d9ee35a20913f87549))
* **select:** relax handling of corner radii for filled variant ([b5c13a7](https://github.com/ifirdausku/material-components-web/commit/b5c13a7a88fdf69bb5515df1dcbb8ce655cfe22c))
* **slider:** resolve Sass deprecation warning ([7971d6a](https://github.com/ifirdausku/material-components-web/commit/7971d6ad5c3a7e771c4a74757b2185edd97443fd))
* **tabs:** rolling back style changes due to screenshot breakages. ([5e5c2af](https://github.com/ifirdausku/material-components-web/commit/5e5c2afc06d26a4d091570baf223d8abd79a2f06))
* **tabs:** rolling back style changes due to screenshot breakages. ([2155064](https://github.com/ifirdausku/material-components-web/commit/215506426df0e309e27ce46898c9e5ea6c51da90))
* **textfield:** Add support for `focus-active-indicator-height` token. ([8c56759](https://github.com/ifirdausku/material-components-web/commit/8c56759428e34766e263008470390487417f00c4))
* **textfield:** Fix bugs and compilation errors due to custom properties in the theme map ([1dc797e](https://github.com/ifirdausku/material-components-web/commit/1dc797e7f4efe9010be7097b040c0fcb1902ca8c))
* **textfield:** Fix several tokens in theming API ([d3344c1](https://github.com/ifirdausku/material-components-web/commit/d3344c16fd9c006059174e1c3b6d90d2302e8134))
* **textfield:** Fix several tokens in theming API ([9f17ff2](https://github.com/ifirdausku/material-components-web/commit/9f17ff2cb20cb503cedcadbc473b09bc77c6a93e))
* **textfield:** Fix several tokens in theming API ([271aedc](https://github.com/ifirdausku/material-components-web/commit/271aedc306a6adc6acc1f2fe2bb460604c7c3a75))
* **textfield:** initializes 'valid' property from the DOM. ([b836b98](https://github.com/ifirdausku/material-components-web/commit/b836b989225a6259220a98dd23fd2a4b99014031))
* **textfield:** Make it possible to customise leading and trailing icon in disabled states separately ([00d8de0](https://github.com/ifirdausku/material-components-web/commit/00d8de0aadef3f3caffc1ca2a13cf932057dcdbe))
* **tooltip:** Fix incorrect measurements of rich tooltip widths on subsequent renders. ([7ab3cd3](https://github.com/ifirdausku/material-components-web/commit/7ab3cd3c82b92e741be2e67ead5c44a0ceabe794))
* **tooltip:** Fixes rich tooltip's theme-styles mixin. ([d584104](https://github.com/ifirdausku/material-components-web/commit/d584104537cafcb624ea14f6b8b9ff6ea937d49a))
* **tooltip:** Fixes rich tooltip's theme-styles mixin. ([697fbde](https://github.com/ifirdausku/material-components-web/commit/697fbdebd4bfaa85e0901855d11c8e7febc9c991))
* **tooltip:** Fixing tooltip's z-index mixin. ([a40e3c7](https://github.com/ifirdausku/material-components-web/commit/a40e3c7684ea43f4a75f6afc75a0b8a34f49b674))
* **tooltip:** Stop keydown event propogation when ESC key is pressed. ([8d2d8d3](https://github.com/ifirdausku/material-components-web/commit/8d2d8d3c4dbe6c2a17a5de099d59f7503101999f))
* **tooltip:** Stop re-calculating the tooltip position if the anchor is scrolled out of view. ([684e33d](https://github.com/ifirdausku/material-components-web/commit/684e33d250337e53e46fec26c97b382ba85f60d0))
* **tooltip:** Uses single quotes when retrieving key value from sass map. ([953e689](https://github.com/ifirdausku/material-components-web/commit/953e689f3bad9b0a2b3c384470fc82a2d4b8df92))
* **touch-target:** touch-target mixin now works as expected also when the arguments are custom property strings. ([0e89aab](https://github.com/ifirdausku/material-components-web/commit/0e89aab6b1651c9a22e6caa3c9a9f4b023ff61c3))
* Makes material component to depend on https://github.com/google/safevalues and be Trusted Type compatible. ([a44241e](https://github.com/ifirdausku/material-components-web/commit/a44241e5428e7f83733b2bd8ab7acc851fc2fb85))
* use case-insensitive comparison for the tabindex attribute ([fd95ca7](https://github.com/ifirdausku/material-components-web/commit/fd95ca7ef8eb8479cf9eedceae6a80da4503595b))


### Features

* **button:** Introduced a new token: `"keep-touch-target"` to the `theme` mixin. ([21d1196](https://github.com/ifirdausku/material-components-web/commit/21d1196a7cae2760582c1cefb64e418e99f7d9b2))
* **button:** Ripple styles do not update on hover for disabled buttons. ([bf86521](https://github.com/ifirdausku/material-components-web/commit/bf86521f45b74c35f2f443dfb41a0c8361b5cf2c))
* **button:** Support state-layer-color theming for buttons and icon-buttons ([127a44b](https://github.com/ifirdausku/material-components-web/commit/127a44b284698c40533b2e52cd0311ec689aa026))
* **checkbox:** Support state-layer-color theming for GM2 checkboxes ([9cec940](https://github.com/ifirdausku/material-components-web/commit/9cec9409719681ad4e33b7369fb402f7e4b787b1))
* **chips:** Make light-theme tokens public ([51311e6](https://github.com/ifirdausku/material-components-web/commit/51311e69ec61d62c214e0020fb856c39919ee657))
* **datepicker, select, textfield:** Support customizing label size on these components. ([c0d21ec](https://github.com/ifirdausku/material-components-web/commit/c0d21ecc9704bea1cb7c8cd83c1c6e2971f1d01b))
* **dialog:** Add `z-indez` token to dialog theme styles mixin ([93fc524](https://github.com/ifirdausku/material-components-web/commit/93fc524b7889f5789096c9be8799ed5b619aed43))
* **dialog:** Adding container-surface-tint as supported token for theme-API. ([446734f](https://github.com/ifirdausku/material-components-web/commit/446734f27bf1f7eadbf9d30c248649f46dd52cda))
* **fab:** Make extended-light-theme tokens public ([736b7fd](https://github.com/ifirdausku/material-components-web/commit/736b7fda40fce0e45eb95ca28df7ae9a7426b365))
* **fab:** Make light-theme tokens public ([b281a40](https://github.com/ifirdausku/material-components-web/commit/b281a409a8d63105dcd7b00dd8cd4a3e274e3495))
* **floatinglabel:** Extract `static-styles` mixin ([419b23c](https://github.com/ifirdausku/material-components-web/commit/419b23cc64946c0df1986986872e0faa58c3e817))
* **floatinglabel:** Extract `theme-styles` mixin ([87809c7](https://github.com/ifirdausku/material-components-web/commit/87809c7103e24f1988763c1103fde000f413c4df))
* **focus ring:** BREAKING_CHANGE Renaming focus-ring files in preparation for splitting focus-ring into two variants. One with an outward entrance animation, and one with an inward animation. ([e8912fd](https://github.com/ifirdausku/material-components-web/commit/e8912fd3741e891a71a19b7370fa922358bdd278))
* **focus ring:** Defining styles for focus ring variant that animates inwards. ([16fbd30](https://github.com/ifirdausku/material-components-web/commit/16fbd30ffe8176e7a049663782c95456eaa95825))
* **focus-ring:** add Sass mixin for testing ([6a4b3f8](https://github.com/ifirdausku/material-components-web/commit/6a4b3f834d4f512a68e46f6fe56c4e52bc737004))
* **focus-ring:** support variable shapes in outward variant ([311ab4d](https://github.com/ifirdausku/material-components-web/commit/311ab4d4aa4367ee99d505b89c1550cce81345e4))
* **focusring:** Extra bottom offset for inward focus ring ([6fcd8d4](https://github.com/ifirdausku/material-components-web/commit/6fcd8d41839a069202e48f7dace96739ad21d078))
* **formfield:** Add `mdc-label` class to `<label>` ([55093ee](https://github.com/ifirdausku/material-components-web/commit/55093ee1e347fc68360a7fa1b45e1cc7f80cc683))
* **formfield:** Add `theme` mixin ([ed7e82d](https://github.com/ifirdausku/material-components-web/commit/ed7e82dedcea18db05621abd0a44a3c002cb65e8))
* **formfield:** Extract `static-styles` mixin ([d441d2a](https://github.com/ifirdausku/material-components-web/commit/d441d2a2ac5a4a69db1fd867a6bf959b1f7492cd))
* **formfield:** Extract `theme-styles` mixin ([48d3001](https://github.com/ifirdausku/material-components-web/commit/48d30012d6605a3038d912d455b98a5f528c2760))
* **linearprogress:** Add `bar-and-track-height` token ([51f9c0c](https://github.com/ifirdausku/material-components-web/commit/51f9c0c28888cc20bcfd982e3c3ee6d8701b276c))
* **linearprogress:** Implement `track-shape` token ([90291f2](https://github.com/ifirdausku/material-components-web/commit/90291f2e27c48df2958bdf5fd1854b79f032cf96))
* **linearprogress:** Implement separate `track-height` and `active-indicator-height` tokens ([3b5b55e](https://github.com/ifirdausku/material-components-web/commit/3b5b55e31a3f69bc1b4f380f57b9276bfb2ad4a8))
* **lineripple:** Extract `static-styles` mixin ([112715d](https://github.com/ifirdausku/material-components-web/commit/112715df5ae369f78b6ef12fe4aa88debb451ef2))
* **lineripple:** Extract `theme-styles` mixin ([1c8013f](https://github.com/ifirdausku/material-components-web/commit/1c8013f4e7f2b10ce1473177ec0f377da4592295))
* **map-ext:** add a `map-get-or-err` helper function. ([d9f8210](https://github.com/ifirdausku/material-components-web/commit/d9f821042d192caddabfa88d0d95c54454cd9a58))
* **menu:** Add `static-styles` mixin ([a274583](https://github.com/ifirdausku/material-components-web/commit/a274583b97fd1fe27eaaca9cba5f890173bebb2e))
* **menusurface:** Extract `static-styles` mixin ([de52246](https://github.com/ifirdausku/material-components-web/commit/de52246336da4a3629d8e85c18e482e8d8cdf1fe))
* **menusurface:** Extract `theme-styles` mixin ([a71501b](https://github.com/ifirdausku/material-components-web/commit/a71501b1332ccb95f49e48ee7c1463ce98a43130))
* **notchedoutline:** Extract `static-styles` mixin ([1bd3172](https://github.com/ifirdausku/material-components-web/commit/1bd317240624d58bf9025046386fd1b25d22227b))
* **notchedoutline:** Extract `theme-styles` mixin ([989ae2e](https://github.com/ifirdausku/material-components-web/commit/989ae2ecc5d9d9636628806a4984e182e44931ba))
* **select:** Add support for `text-field-focus-active-indicator-height` theme key. ([de38de7](https://github.com/ifirdausku/material-components-web/commit/de38de7584a5552e93a3f92db5fb9d397fa2e986))
* **select:** Allow styling bottom border radii in Material Selects. By default, to preserve compatibility with existing styling, border-radius still only styles top radii unless all four values are specified. ([83355c3](https://github.com/ifirdausku/material-components-web/commit/83355c32274a6b461016e449f663a389427364ba))
* **select:** Select foundation preserves describedby elements on validate ([7644d63](https://github.com/ifirdausku/material-components-web/commit/7644d63d5a4eed96766ec063ce76b8e22e362b46))
* **select:** Select foundation preserves describedby elements on validate ([901c83e](https://github.com/ifirdausku/material-components-web/commit/901c83e770dd7c0326c2013eaa5d7bf9dca30a6d))
* **select:** Select foundation preserves describedby elements on validate ([fa27ba6](https://github.com/ifirdausku/material-components-web/commit/fa27ba61d48c66d0d56b93039738380285d9ad4a))
* **slider:** Moves native inputs into thumbs to improve a11y. ([47c7deb](https://github.com/ifirdausku/material-components-web/commit/47c7deb19df667d31f65d7742509fb883e4501f5))
* **snackbar:** Add support for secondary action button ([a9ff986](https://github.com/ifirdausku/material-components-web/commit/a9ff9866f237fbeebe94e655ae578b68ce675a04))
* **text-field:** add the ability to hide the asterisk required marker in floating labels ([f476fde](https://github.com/ifirdausku/material-components-web/commit/f476fdece526e3aa45441b2d11f7ac17f63e856f))
* **textfield:** changed the visibility of the mixin `filled-no-label` to public ([8879557](https://github.com/ifirdausku/material-components-web/commit/8879557e677d9b160a106e46279b1b6855926fb5))
* **textfield:** Changed visibility of $custom-property-prefix to public ([d96330c](https://github.com/ifirdausku/material-components-web/commit/d96330c085b4fe8fc59c7eb835d41ebca3a08422))
* **textfield:** Changed visibility of $custom-property-prefix to public ([f323399](https://github.com/ifirdausku/material-components-web/commit/f323399371aec4378186a05b5a839e53d9e464c0))
* **tooltip:** Interactive rich tooltip content becomes scrollable if it extends beyond the max-height limit. ([0ad1283](https://github.com/ifirdausku/material-components-web/commit/0ad128337d689ca084fbda457a7204daa750b792))
* Modify NotifyOpening event to emit after adding the "--opening" class so that the banner's contentHeight is visible to listeners handling the `opening` event ([b2ddacf](https://github.com/ifirdausku/material-components-web/commit/b2ddacf738a9fc404225ff2c23169000dd69ddd1))
* **banner:** Updating `theme-styles` mixin to emit custom properties. ([a6e1c07](https://github.com/ifirdausku/material-components-web/commit/a6e1c07025c66d0d29ac4c66584474a336b5ef26))
* **button:** Mixin styling for progress buttons ([2860d24](https://github.com/ifirdausku/material-components-web/commit/2860d244d9fc4c5bf47d3f03e7dc60bbfc56c7c9))
* **chips:** fix HCM chip styles ([86efd56](https://github.com/ifirdausku/material-components-web/commit/86efd56f6a2aa9870a8457900e686bc35d3cb3bc))
* **datatable:** Add `theme-styles` and `theme` mixins ([92b2556](https://github.com/ifirdausku/material-components-web/commit/92b2556cff2267b5f3e465c682b7dc032ba2be41))
* **datatable:** Expose `$custom-property-prefix` for internal usage ([cfd6949](https://github.com/ifirdausku/material-components-web/commit/cfd69490f088d578e2a9a6d06d386212e04048bd))
* **datatable:** Use generated tokens for Theming API ([bb77510](https://github.com/ifirdausku/material-components-web/commit/bb7751002a9f5c35137425219afb38c88d0bacc3))
* **datepicker:** datepicker textfield theming api ([a86d36f](https://github.com/ifirdausku/material-components-web/commit/a86d36fd2ac987f5a7ca160470964ff58b198300))
* **dialog:** add a scrim-less dialog, that does not block interaction with the page ([2a6ddc1](https://github.com/ifirdausku/material-components-web/commit/2a6ddc1cff903da5e17766a214d76fc8cb3904d8))
* **fab:** Add support for container-surface-tint-layer-color ([e340b04](https://github.com/ifirdausku/material-components-web/commit/e340b04c53f1b8db0951fc51a3e368231f39a781))
* **focus:** Add focus ring component. ([587d8f8](https://github.com/ifirdausku/material-components-web/commit/587d8f871df33f9f7584d9e6612389e93c6eb04f))
* **focus:** Remove `focus-ring.theme-component` and `focus-ring.theme-component-derived` mixins. ([43f5323](https://github.com/ifirdausku/material-components-web/commit/43f5323bc078a4ed7df651a0170973194dd9031d))
* **focus-ring:** Added a SASS function to help more easily mold the focus ring around its corresponding component's shape. ([32d8a96](https://github.com/ifirdausku/material-components-web/commit/32d8a96486823b6dfe077278114c12aed2a14bf5))
* **focus-ring:** Adds animation for focus-ring. ([c492898](https://github.com/ifirdausku/material-components-web/commit/c492898c238efd7a46476f4c0181e65bbbe04778))
* **linearprogress:** Added theme mixin that declares custom properties in MDC linear progress ([d25f340](https://github.com/ifirdausku/material-components-web/commit/d25f3404c0a8658f2639cd7845a98aef62063988))
* **list:** Add support for list-item-selected-container-color and list-item-selected-trailing-icon-color tokens. ([ece3e8d](https://github.com/ifirdausku/material-components-web/commit/ece3e8d2155abd93bc1f9bdcf2dddea9e6eaab56))
* **list:** Add support for several new tokens ([cec7fb9](https://github.com/ifirdausku/material-components-web/commit/cec7fb9878e548f7f070c5b0f9572cf34e3cce36))
* **list:** Changing default value of `areDisabledItemsFocusable` to false. ([65c4116](https://github.com/ifirdausku/material-components-web/commit/65c411674c70291e64bf0deaca88f8b68586ba82))
* **list:** Creates a `static-styles` mixin that holds all the non-themeable list styles. ([73ca9db](https://github.com/ifirdausku/material-components-web/commit/73ca9dbb058c47c557aff16137277a7bd33d0b8c))
* **list:** Creates a static-styles mixin that holds all the non-themeable list styles. ([58733ef](https://github.com/ifirdausku/material-components-web/commit/58733ef418bf8641a5b3b7fd33e8e2bb1d0e7b97))
* **list:** Defines a `theme` mixin for list component. Also adjusts the `theme-styles` mixin so that it emits custom properties. ([3cc30f6](https://github.com/ifirdausku/material-components-web/commit/3cc30f6adb6a5496601dd458a8a9ef40ffef7ff6))
* **list:** Fixes focus behavior on disabled list items when `areDisabledItemsFocusable` is set to `false`. ([2aa8050](https://github.com/ifirdausku/material-components-web/commit/2aa8050b46b7b170ab9ecc2a1fe9686ac40d79cc))
* **list:** Removes ripple styling on disabled list items. ([eaa0c3a](https://github.com/ifirdausku/material-components-web/commit/eaa0c3a8603d70489b22b68a2b0e6ec4284de3a5))
* **menu:** working on theming API ([f1e0371](https://github.com/ifirdausku/material-components-web/commit/f1e0371502ee9bfe48f3501a63f70a42bfd79cb8))
* **select:** Add `text-field-leading-icon-size` and `text-field-trailing-icon-size` support for theming API. ([3777b03](https://github.com/ifirdausku/material-components-web/commit/3777b03cbed27a4569a72535c51ce7c33510fc76))
* **select:** add support for menu related tokens ([b5606a7](https://github.com/ifirdausku/material-components-web/commit/b5606a793c301932f9f28a2f7f55b37201fe2634))
* **select:** add support for supporting text related tokens ([6048fb5](https://github.com/ifirdausku/material-components-web/commit/6048fb5638e16e5eb1637cc2f617bc56e2955fb4))
* **select:** add theme mixin to emit CSS Custom Properties. ([e74b7ba](https://github.com/ifirdausku/material-components-web/commit/e74b7ba7e4ffb1999c0ef80f45e2b08b01353930))
* **select:** Copy over aria-label from option to selected text ([ecfee94](https://github.com/ifirdausku/material-components-web/commit/ecfee946fb16d47fa35a2f53d4d1ed3f5ecf7a9e))
* **select:** Copy over aria-label from option to selected text ([13e9b0d](https://github.com/ifirdausku/material-components-web/commit/13e9b0d1f2d795ecf7b9ab782e1dda0f25b603b1))
* **select:** Copy over aria-label from option to selected text ([c9b1a31](https://github.com/ifirdausku/material-components-web/commit/c9b1a31e424b9e90c4a112cd3175fffae112af88))
* **select:** do not emit styles when calling `theme-styles(())`. ([18b8f31](https://github.com/ifirdausku/material-components-web/commit/18b8f31e17972cdd2db5cae3c584035b535bf44b))
* **textfield:** Add `static-styles` mixin ([82554d7](https://github.com/ifirdausku/material-components-web/commit/82554d7709f8945af78415597d9b121afaddd1c0))
* **textfield:** Add character counter to theming api ([1d37bf6](https://github.com/ifirdausku/material-components-web/commit/1d37bf601f471b43f5b313bbc8ea58def2cc5c9f))
* **textfield:** add support for several new tokens ([d71935c](https://github.com/ifirdausku/material-components-web/commit/d71935c8bf8dd6e1a4a7a38e57d02d3de4f56f67))
* **textfield:** Changed visibility of $custom-property-prefix to public. ([274610c](https://github.com/ifirdausku/material-components-web/commit/274610c77e6a9c9f19780b688cc6686a97e453a1))
* **textfield:** Ensure Theming API feature consistency ([7134a77](https://github.com/ifirdausku/material-components-web/commit/7134a7752e5d06837e1eb3da7f2b49d6ba9fb72c))
* **theme:** allow to specify varname prefix in custom-properties configuration ([f0a0bbc](https://github.com/ifirdausku/material-components-web/commit/f0a0bbc754058398bdef427d3646a0794a07047a))
* **tooltip:** Adjust rich tooltip's theme and theme-styles mixins. ([7c73f61](https://github.com/ifirdausku/material-components-web/commit/7c73f6134470aaf1ef7f7ab931ba0c658116cf18))
* **tooltip:** Calls resolvers in theme-mixins to resolve typography tokens. ([66c5cbb](https://github.com/ifirdausku/material-components-web/commit/66c5cbb9446da83a6c48570e12b1ab71cae3c77f))
* **tooltip:** No longer re-calculate persistent rich tooltip's position on scroll. ([5cb8e21](https://github.com/ifirdausku/material-components-web/commit/5cb8e2174bb381556fc684283748659b322dc158))
* **tooltip:** Updates to accessibility guidance states that we want all rich tooltips to be reachable via screenreader linear navigation. The idea is that the user should always be able to hear the message of a rich tooltip line-by-line regardless of if the tooltip is interactive, non-interactive, persistent, or non-persistent. ([5490e32](https://github.com/ifirdausku/material-components-web/commit/5490e32e718b4357ee6b58c329fdae28f89ea171))
* **tooltip:** When calculating rich tooltip width, we now take the viewport width into account. ([817002c](https://github.com/ifirdausku/material-components-web/commit/817002c296d5a9220c2b940e3383fdd42ca2aa87))
* **touch-target:** margin mixin now also allows custom property maps as arguments. ([dd99c87](https://github.com/ifirdausku/material-components-web/commit/dd99c87645f91ff535df8d50be84ffcfd643ae47))
* add elevation theming to menu ([86bde5c](https://github.com/ifirdausku/material-components-web/commit/86bde5c063e806f975d836d6a875f2fdaa7cdc67))
* add icon support to menu theming ([40b18d0](https://github.com/ifirdausku/material-components-web/commit/40b18d04314549060c2b4a28ed425cba9976687b))
* add simpler theming validation functions ([558c2be](https://github.com/ifirdausku/material-components-web/commit/558c2be6282cfe6db7f166d21350f866011955f8))
* **tooltip:** Updating `handleDocumentClick` method to utilize a new `isInstanceOfElement` adapter method. ([9af09b9](https://github.com/ifirdausku/material-components-web/commit/9af09b967a7c01c6c45d2afb5cbb00f0e43904ce))
* generate M3 tokens for v0.132 ([70b8ac1](https://github.com/ifirdausku/material-components-web/commit/70b8ac16e68eb842315374c551e597f02d3d3a1d))
* Support '-5' density for text fields ([e457014](https://github.com/ifirdausku/material-components-web/commit/e4570146f182059e919d089d26bc6b2813015f10))
* Update icon button theme `size` function to be able to accept values with rem units. ([0e3dc8e](https://github.com/ifirdausku/material-components-web/commit/0e3dc8e3892e2cda93062eb64ff498dbc18203f3))
